...
object ModelSelectionViaCrossValidationExample {
  ...
  def main(args: Array[String]): Unit = {
    ...
    println(">>>> cvModel.bestModel.extractParamMap : " + cvModel.bestModel.extractParamMap())
    println(">>>> cvModel.avgMetrics : " + cvModel.avgMetrics.toSeq)
    
    //--bestModel 내용 확인....=> best Param 확인....
    cvModel.write.overwrite().save(this.getClass.getName)
